...
- "This is where..." or "That is where..."
- "This should be done" or "This must be done" in personal writeups
...
- Hedging qualifiers are fine ("quite", "rather", "fairly") - these can look a little redundant but honestly, I think this adds a humane element to sentences
- For personal setup posts, prefer "I did this", "I changed this", "I kept this", and "I decided this" over guide-style commands like "do this", "use this", or "change that"
- If something is optional for the reader, frame it lightly with "you could" or "maybe this is useful" instead of "you should"
- Avoid artificial summary beats that sound like a pitch or case study. Let the reasoning flow naturally from the setup
...
## 7. Punctuation And Links

- Avoid colons as fake dramatic breakpoints in prose
- Prefer two normal sentences over a colon-punchline sentence
- Avoid em dashes for dramatic turns
- Apply punctuation rules to prose only
- Do not remove or avoid necessary syntax in URLs, Markdown links, frontmatter, YAML, code blocks, key-value config, timestamps, or command output
- `https://example.com`, `[blog post](https://example.com)`, `key: value`, and `03:05` are technical syntax, not writing style problems
